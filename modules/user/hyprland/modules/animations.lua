...
local animations = {
  ...
  { leaf = "windowsMove", enabled = true, speed = 3.5, bezier = "ease-out-back", style = "gnomed" },
  ...
  { leaf = "layersIn", enabled = true, speed = 0.4, bezier = "linear", style = "fade 1%" },
  { leaf = "layersOut", enabled = true, speed = 0.4, bezier = "linear", style = "fade 1%" },
  ...
  { leaf = "workspaces", enabled = true, speed = 6.5, bezier = "macosSlide", style = "slide" },
