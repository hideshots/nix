...
local layer_rules = {
  ...
  { name = "quickshell-control-center-tile-1x1-blur", namespace = "^quickshell:control-center-tile-1x1$", ignore_alpha = blur_cutoff.soft },
  { name = "quickshell-control-center-tile-2x1-blur", namespace = "^quickshell:control-center-tile-2x1$", ignore_alpha = blur_cutoff.soft },
  { name = "quickshell-control-center-tile-2x2-blur", namespace = "^quickshell:control-center-tile-2x2$", ignore_alpha = blur_cutoff.soft },
  { name = "quickshell-control-center-tile-4x1-blur", namespace = "^quickshell:control-center-tile-4x1$", ignore_alpha = blur_cutoff.soft },
